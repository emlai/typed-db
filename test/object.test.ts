...
test('objects can be added', async () => {
  ...
  expect(db.orders.getAll()).toStrictEqual([{ id: 'a', price: 1 }, { id: 'b', price: 2 }, { id: 'c', price: 2 }])
})
...
test('objects can be updated', async () => {
  ...
  expect(db.orders.getAll()).toStrictEqual([{ id: 'a', price: 3 }, { id: 'b', price: 3 }, { id: 'c', price: 3 }])

  db.orders.update({ price: 0, id: '' })
  expect(db.orders.getAll()).toStrictEqual([{ id: '', price: 0 }, { id: '', price: 0 }, { id: '', price: 0 }])
})
